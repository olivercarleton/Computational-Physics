...
while N<maxpoints:    # loop over number of points
    ...
    Nvalues.append(N)
    traperror.append(trapezoid(A,B,N))# Error in Trapezoid method
    simpsonerror.append(simpson(A,B,N)) # Error in Simpson method
    rombergerror.append(Romberg_extrap(A,B,N)) # Error
...
ylabel('Results of Numerical Integartion')
title('Integral Singularity Range [0,1]')
ylim([0.8,1.0])   # set range of y values
